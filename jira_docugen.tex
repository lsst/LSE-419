...
\endhead
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T278}{Verify Out of band leakage with tunable laser and dome calibration system} \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T446}{Data Processing Campaign: Process Filter Response Verification Data (with flat field screen)} \tabularnewline
    \hyperref[lvv-t447]{LVV-T447} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T447}{Data Processing Campaign: Process Filter Response Verification Data (with CBP)} \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1002}{Contribution of templates to difference image noise (Mini Survey Verification)} \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1068}{Identification of deep image artifacts via comparison with external data sets.} \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1075}{Sky Brightness Precision 2} \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1084}{Smoothness of Rowe statistics on angular scales of 1 arcmin < theta < 5 arcmin} \tabularnewline
\bottomrule
\end{longtable}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T278}{LVV-T278}
    - Verify Out of band leakage with tunable laser and dome calibration system}\label{lvv-t278}
...
~\\
        ...
        \\ \midrule
            ...
            \begin{minipage}[t]{13cm}{\footnotesize
            Repeat the above for each of the 6 filters.\\
~\\
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T310}{LVV-T310}
    - Test cross-talk magnitudes (with CBP)}\label{lvv-t310}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T311}{LVV-T311}
    - Test off-raft cross-talk limits}\label{lvv-t311}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T312}{LVV-T312}
    - Test cross-talk stability and accuracy for AP, DRP}\label{lvv-t312}
...
ranging from less than 1 arcmin to greater than 5 arcmin.\\
~\\
This will require the CoaddPsf model for calculating residuals. To
calculate residuals, obtain the CoaddPsf model evaluated at the
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T390}{LVV-T390}
    - The spatial uniformity of photometric zeropoints}\label{lvv-t390}
...
\item \href{https://jira.lsstcorp.org/browse/LVV-1373}{LVV-1373} - OSS-REQ-0387-V-02: Photometric Performance\_2
...
that zero points can be determined. ~Reserve some portion of the
standard stars to test that are not used in determining the zero point.
~Alternatively, identify specific marker points in color-color diagrams
that can be used to define relative zero point offsets. ~Requires both
bright and faint samples.
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T446}{LVV-T446}
    - Data Processing Campaign: Process Filter Response Verification Data (with flat field screen)}\label{lvv-t446}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T447}{LVV-T447}
    - Data Processing Campaign: Process Filter Response Verification Data (with CBP)}\label{lvv-t447}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T450}{LVV-T450}
    - Science Data Pixel Noise Test #1}\label{lvv-t450}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T460}{LVV-T460}
    - Verify Ellipticity Residuals w/ On-Sky Data for Single Exposures}\label{lvv-t460}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T526}{LVV-T526}
    - Usable Pixel Fraction}\label{lvv-t526}
...
\item \href{https://jira.lsstcorp.org/browse/LVV-13367}{LVV-13367} - OSS-REQ-0387-V-06: Photometric Performance\_6
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T840}{LVV-T840}
    - Color Zeropoints}\label{lvv-t840}
...
\item \href{https://jira.lsstcorp.org/browse/LVV-1374}{LVV-1374} - OSS-REQ-0387-V-03: Photometric Performance\_3
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T841}{LVV-T841}
    - Physical Scale Transform}\label{lvv-t841}
...
\item \href{https://jira.lsstcorp.org/browse/LVV-13365}{LVV-13365} - OSS-REQ-0387-V-04: Photometric Performance\_4
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T853}{LVV-T853}
    - Resolved Source RMS}\label{lvv-t853}
...
\item \href{https://jira.lsstcorp.org/browse/LVV-13370}{LVV-13370} - OSS-REQ-0387-V-09: Photometric Performance\_9
...
shutdown (within 24 hours of the observation)\\
~\\
Define a \textbf{failed visit} as one where no alerts are generated on
any CCD in that visit by shutdown of processing.
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1002}{LVV-T1002}
    - Contribution of templates to difference image noise (Mini Survey Verification)}\label{lvv-t1002}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1011}{LVV-T1011}
    - Observatory operations during communications blackout -- 48 hours}\label{lvv-t1011}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1012}{LVV-T1012}
    - Level 2 astrometric accuracy}\label{lvv-t1012}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1023}{LVV-T1023}
    - Calibration of Atmospheric Transmission}\label{lvv-t1023}
...
minimize dithers and rotations in the repeat observations!\\
~\\
Identify bright, isolated, non-variable point sources, run DM stack
algorithms. ~Test refers to "color" dependent atmosphere, so ensure that
we have a wide range from red to blue included in the test stars~
...
Celestial Pole one of the repeated observation fields.
            ...
            & Expected Result &
                \begin{minipage}[t]{13cm}{\footnotesize
                catalogs with "pre-correction" magnitudes for stars with a wide range of
colors
...
"pre-correction" (instrumental magnitudes?) in each ~of the ugrizy bands
for the set of stars, and "post-correction" magnitudes for the same
objects.
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1030}{LVV-T1030}
    - Zeropoint uniformity due to DM}\label{lvv-t1030}
...
catalogs that do not include the sources selected in step 2.\\
~\\
By running the processing with different reference catalogs, we should
be able to isolate the effects of the DM pipelines.
...
for each object in the test set is less than 0.003 magnitudes.\\
~\\
(This should verify the consistency of the color zeropoints)
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1031}{LVV-T1031}
    - Photometric repeatability due to DM pipeline}\label{lvv-t1031}
...
2.\\
~\\
By re-running jointcal with different reference catalogs, we hope to
isolate the effect of the DM pipelines on photometric repeatability.
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1032}{LVV-T1032}
    - Photometric repeatability due to field of view variation}\label{lvv-t1032}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1033}{LVV-T1033}
    - Generate grid of sources with CBP}\label{lvv-t1033}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1034}{LVV-T1034}
    - Effect of gain on photometric repeatability -- 12 hours}\label{lvv-t1034}
...
step 2 to within 0.01 magnitude.\\
~\\
(This does not account for the "on spatial scales equal to a single
output amplifier" part of the requirement; I'm not sure what that means
in the context of photometric repeatability)
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1035}{LVV-T1035}
    - Effect of gain variations on photometric repeatability -- 1 hr}\label{lvv-t1035}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1037}{LVV-T1037}
    - Gain variation -- 1 hr}\label{lvv-t1037}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1038}{LVV-T1038}
    - Attenuation of large scale gain variation errors}\label{lvv-t1038}
...
of 10**5 (!) lower than the residuals in step 3.\\
~\\
That factor of 10**5 seems extreme, but that is the amplitude equivalent
of 100 decibels of attenuation.
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1039}{LVV-T1039}
    - Attenuation of small scale gain variation over short time scales}\label{lvv-t1039}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1040}{LVV-T1040}
    - Attenuation of gain variation of an hour}\label{lvv-t1040}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1041}{LVV-T1041}
    - Stray light within 45 degrees of the moon}\label{lvv-t1041}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1043}{LVV-T1043}
    - Flat fielding errors -- effect on photometric repeatability}\label{lvv-t1043}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1044}{LVV-T1044}
    - Flat fielding -- raw effect on photometric repeatability}\label{lvv-t1044}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1046}{LVV-T1046}
    - Crosstalk functionality exists}\label{lvv-t1046}
...
per amplifier.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 2 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Analyze image from step 1 with all crosstalk coefficients set to zero.\\
~\\
(Do we need to specify that we are using the same algorithms as the
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1048}{LVV-T1048}
    - Crosstalk coefficient measurement capability}\label{lvv-t1048}
...
Section 4.2.10 ~- CBP Crosstalk Measurement.\\
~\\
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1051}{LVV-T1051}
    - color zero point accuracy due to wavelength dependent atmosphere}\label{lvv-t1051}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1052}{LVV-T1052}
    - Galaxy shape verification on recalculated deep coadds}\label{lvv-t1052}
...
\subsubsection{Input Specification}
The following components will be used in this test.\\
~\\
...
~\\
this will do an initial pass at detection and deblending, merge catalogs
across filters to make a consistent table for sources across filters.
Finally, it will and perform measurement on the sources using their
improved positions from the merge process, including shape measurement.
(this is at least true at the time of writing for HSC's
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1053}{LVV-T1053}
    - Photometric repeatability due to atmosphere calibration across the sky}\label{lvv-t1053}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1054}{LVV-T1054}
    - Photometric Calibration Uniformity due to atmosphere}\label{lvv-t1054}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1055}{LVV-T1055}
    - Maximum gray atmosphere effect}\label{lvv-t1055}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1056}{LVV-T1056}
    - Instrumental Calibration reproducibility}\label{lvv-t1056}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1057}{LVV-T1057}
    - Instrumental/System zero point uniformity}\label{lvv-t1057}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1065}{LVV-T1065}
    - Bias Image Pixel Noise Test}\label{lvv-t1065}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1066}{LVV-T1066}
    - Sky imaging test of cross-talk accuracy and stability}\label{lvv-t1066}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1067}{LVV-T1067}
    - Cross-talk significance}\label{lvv-t1067}
...
\item \href{https://jira.lsstcorp.org/browse/LVV-13368}{LVV-13368} - OSS-REQ-0387-V-07: Photometric Performance\_7
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1068}{LVV-T1068}
    - Identification of deep image artifacts via comparison with external data sets.}\label{lvv-t1068}
...
~\\
The matching should likely only be done via position as variable, yet
persistent objects may present different brightness.
...
\includegraphics{../rest/tests/1.0/attachment/image/404}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1070}{LVV-T1070}
    - On-sky Observations: 10-year Depth SV Survey}\label{lvv-t1070}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1071}{LVV-T1071}
    - On-sky Observations: 20-year Depth Test}\label{lvv-t1071}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1072}{LVV-T1072}
    - Data Processing Campaign: Data Release Processing}\label{lvv-t1072}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1073}{LVV-T1073}
    - On-sky Observations: Wide-area SV Survey}\label{lvv-t1073}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1074}{LVV-T1074}
    - Sky Brightness precision}\label{lvv-t1074}
...
\item \href{https://jira.lsstcorp.org/browse/LVV-13366}{LVV-13366} - OSS-REQ-0387-V-05: Photometric Performance\_5
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1075}{LVV-T1075}
    - Sky Brightness Precision 2}\label{lvv-t1075}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1078}{LVV-T1078}
    - Generate matched DIASource catalog}\label{lvv-t1078}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1081}{LVV-T1081}
    - Completeness vs. magnitude via external catalogs}\label{lvv-t1081}
...
corresponding detected object in the LSST catalog.\\
~\\
The matching should be done via position, but may be improved by
requiring similar magnitudes between the two catalogs (keeping in mind
that variable, yet persistent, objects may present different brightness,
and thus would not necessarily pass a magnitude criterion).
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1082}{LVV-T1082}
    - Completeness vs. magnitude via injected sources}\label{lvv-t1082}
...
is a corresponding detected object in the output LSST catalog.\\
~\\
The matching should be done via position, but may be improved by
requiring similar magnitudes between the two catalogs.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 6 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            In magnitude bins, count the fraction of objects from the input "truth"
catalog that had a corresponding detected object in the LSST dataset.
Plot this fraction (the "completeness") as a function of magnitude, for
(1) all sources, (2) objects inserted as stars, and (3) objects inserted
as galaxies.
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1083}{LVV-T1083}
    - Single Visit Ellipticity Residuals w/ on sky data}\label{lvv-t1083}
...
brightness etc.\\
~\\
obtain the PSF models from these calexps as well.
...
ranging from less than 1 arcmin to greater than 5 arcmin.\\
~\\
This will require the PSF model for calculating residuals. To calculate
residuals, obtain the PSF model evaluated at the positions of stars of
interest, and find the difference in the measured ellipticity of stars,
and the model ellipticity.
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1084}{LVV-T1084}
    - Smoothness of Rowe statistics on angular scales of 1 arcmin < theta < 5 arcmin}\label{lvv-t1084}
