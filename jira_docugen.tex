...
in the reference catalog.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 3 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Jointcal on the images from step 1 using different reference catalogs
that do not include the sources selected in step 2.\\
~\\
...
reprocessings done ins step 3. ~Calculate (ZP-medianZP) within each
