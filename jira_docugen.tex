...
diagnostic purposes.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 3 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            For each stellar sample, compute all Rho statistics over angular scales
...
ellipticity of stars, and the model ellipticity.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 4 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Extract the amplitudes of the rho statistics at angular scales of 1
...
for each Rho statistic, collect the amplitudes of the Rho statistics.
...
examine for this test.
        ...
        \\ \midrule
            ...
            \begin{minipage}[t]{13cm}{\footnotesize
            Confirm that the Rho statistics are smooth through 1 arcmin to 5 arcmin
...
them
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 4 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Extract the simulated sources after association. ~Verify that they are
not misassociated with the incorrect DIAObjects at a larger than
