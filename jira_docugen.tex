...
% using docsteady version 1.1.3.post4+g1808947.d20190423
...
% using template at <template>.
% Collecting ATM data from folder: "/Project Systems Engineering/Commissioning Science Verification|LSE-419"
% using dosteady version 1.1.3.post4+g1808947.d20190423
% Please do not edit -- update information in Jira instead

\section{Traceability}
\scriptsize{
\begin{longtable}[]{p{6cm}p{2cm}p{2cm}p{1.5cm}p{2cm}p{1.5cm}}
\toprule
